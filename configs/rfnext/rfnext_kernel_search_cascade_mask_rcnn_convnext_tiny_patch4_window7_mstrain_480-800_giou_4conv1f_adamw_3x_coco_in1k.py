...
checkpoint_file = 'kernel_convnext-tiny_best-ema_ema-weight.pth'  # noqa
cudnn_benckmark=True
model = dict(
    backbone=dict(
        _delete_=True,
        type='mmcls.ConvNeXt',
    ...
    rfsearch_cfg=dict(
        ...
        kernel_file='./configs/rfnext/search_log/convnext_cascade_maskrcnn/local_search_config_step11.json',
        config=dict(
            search=dict(
                step=0,
                max_step=12,
